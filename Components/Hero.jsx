...
function Hero({titleData,createCampaign}) {
  ...
  const createNewComapign=async(e)=>{
    e.preventDefault();
    try{
      ...
      <div className='relative bg-opacity-75 backgroundMain'>
        ...
        <div className='relative px-4 py-16 mx-auto overflow-hidden sm:max-w-xl md:max-w-full lg:max-w-screen-xl md:px-24 lg:px-8 lg:py-20 flex flex-col md:flex-row justify-evenly'>
          <div className='w-full max-w-xl mb-12 xl:mb-0 xl:pr-16 xl:w-7/12'>
            ...
            >Learn More
            <svg className='inlinr-block w-3 ml-2'
            fill="currentColor"
            viewBox='0 0 12 12'>
              {/* <path d="M9.707,5.2931-5A1,1,0,0,0,3.293,1.707L7.586,6,3.293,10.293a1,1,0,1,0,1.414,1.414l5--5A1,1,0,0,0,9.707,5.2932" /> */}
            </svg>
            </a>
          </div>
            ...
            <div className='bg-white rounded shadow-2xl p-7 sm:p-10'>
              ...
              <form>
                ...
                <div className='mb-1 sm:mb-2'>
                  <label htmlFor="firstname" className='inline-block mb-1 font-medium'>Title</label>
                ...
                <div className='mb-1 sm:mb-2'>
                  <label htmlFor="amount" className='inline-block mb-1 font-medium'>Amount</label>
                  <input onChange={(e)=>setCampaign({
                    ...campaign,
                ...
                <div className='mb-1 sm:mb-2'>
                  <label htmlFor="deadline" className='inline-block mb-1 font-medium'>Deadline</label>
                  <input onChange={(e)=>setCampaign({
                    ...campaign,
